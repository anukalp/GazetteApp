...
public class ResultFragment extends Fragment {
    ...
    private void init() {
        ...
        originalButton = (FloatingActionButton) view.findViewById(R.id.original);
        originalButton.setOnClickListener(new OriginalButtonClickListener());
        MagicColorButton = (FloatingActionButton) view.findViewById(R.id.magicColor);
        MagicColorButton.setOnClickListener(new MagicColorButtonClickListener());
        grayModeButton = (FloatingActionButton) view.findViewById(R.id.grayMode);
        grayModeButton.setOnClickListener(new GrayButtonClickListener());
        bwButton = (FloatingActionButton) view.findViewById(R.id.BWMode);
